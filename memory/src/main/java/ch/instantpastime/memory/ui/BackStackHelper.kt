 ...
 */
class BackStackHelper(private val activity: MemoryActivity) {
    ...
    private val nback_fragment_container: FrameLayout
        get() { return activity.memory_fragment_container}
    ...
    private fun getCurrentMenuItemId(): Int? {
        return when (val fragment = supportFragmentManager.findFragmentById(R.id.memory_fragment_container)) {
            null -> null
    ...
    private fun buildFragment(@IdRes menuItemId: Int): Fragment? {
        return when (menuItemId) {
            R.id.navigation_home -> MemoryFragment()
            //R.id.navigation_option -> MemoryPreferenceFragment()
            else -> null
        }
    }
    ...
    private fun getMenuItemIdFrom(fragment: Fragment): Int? {
        return when (fragment) {
            is MemoryFragment -> R.id.navigation_home
            //is MemoryPreferenceFragment -> R.id.navigation_option
            else -> null
        }
    }
    ...
    fun loadFragment(@IdRes menuItemId: Int): Boolean {
        ...
        return if (nav_view.selectedItemId == menuItemId &&
            supportFragmentManager.findFragmentById(R.id.memory_fragment_container) != null) {
            ...
            if (newFragmentEntry != null) {
                ...
                supportFragmentManager.beginTransaction().apply {
                    replace(R.id.memory_fragment_container, newFragmentEntry.generator(null))
